...
COUNTRIES = {
    ...
    "US": {
        ...
        "group": "EXTERNAL",
        "priority": "high",
        "aliases": ["united states", "usa", "u.s.", "u.s.a.", "american", "america"]
    },
    "GB": {
        "name": "United Kingdom",
        "group": "EXTERNAL",
        "priority": "high",
        "aliases": ["united kingdom", "uk", "britain", "british", "great britain", "england"]
    },
    "RU": {
        "name": "Russia",
        "group": "EXTERNAL",
    ...
    "CN": {
        ...
        "group": "EXTERNAL",
        "priority": "high",
        "aliases": ["china", "chinese", "prc", "people's republic of china"]
    },
    "TR": {
        "name": "Turkey",
        "group": "EXTERNAL",
        "priority": "high",
        "aliases": ["turkey", "turkish", "türkiye", "turkiye"]
    }
}
...
EXTERNAL_COUNTRY_CODES = ["US", "GB", "RU", "UA", "CN", "TR"]
